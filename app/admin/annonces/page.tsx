  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-[#00458E] mb-8">Gestion des annonces</h1>
        <div className="text-right">
          <Button className="bg-[#F5A623] hover:bg-[#E59512] text-white">Créer une annonce</Button>
        </div>
      </div>
